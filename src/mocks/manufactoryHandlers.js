...
export const Handlers = [
  // table 1
  rest.get('/api/manufactory-management', (req, res, ctx) =>
    res(ctx.status(200), ctx.json(informationResult)),
  ),
  // table 2
  rest.get('/api/manufactory-measure-history', (req, res, ctx) =>
    res(ctx.status(200), ctx.json(informationResult)),
  ),
  // table 3
  rest.get('/api/manufactory-accident-history', (req, res, ctx) =>
    res(ctx.status(200), ctx.json(informationResult)),
  ),
  // table 4
  rest.get('/api/manufactory-history', (req, res, ctx) =>
    res(ctx.status(200), ctx.json(informationResult)),
  ),
];
