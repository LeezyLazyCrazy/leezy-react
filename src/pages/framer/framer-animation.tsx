        ...
        <>
            <Grid xs={12}>
                ...
                <div className="why" style={{ color: "#00ffff", fontSize: "20px" }}>
                    ...
                    <p style={{color: "#ffffff", fontSize: "15px"}}>1.  애니메이션, 터치 기반 제스처 및 스크롤, 페이징 및 인터페이스 흐름을 위한 여저 재사용 컴포넌트를 제공하는 라이브러리</p>
                    <p style={{color: "#ffffff", fontSize: "15px"}}>2.  개발 사이드와 동기화된 생산성 있는 워크플로우.</p>
                    <p style={{color: "#ffffff", fontSize: "15px"}}>3.  디자인 시스템 구조를 팀의 입맛에 맞게 바꿀 수 있음.</p>
