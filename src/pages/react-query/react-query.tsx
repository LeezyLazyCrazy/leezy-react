    ...
    <Grid xs={12}>
      ...
      <div className="Example" style={{ color: '#fffb00', fontSize: '20px' }}>
        <div>
          ...
          <p style={{ color: '#ffffff', fontSize: '15px' }}>
            기존의 데이터 패칭에는 로딩 상태 관이 및 패칭한 데이터 관리 등을 위해 여러 훅을 사용해야
            했으나, 리액트 쿼리를 사용하면 훨씸 간결하게 로직을 작성할 수 있다.
          </p>
        ...
        <div style={{ display: 'inline-block', marginLeft: '10px' }}>
          <p style={{ color: '#ffffff', fontSize: '15px' }}>
            {' '}
            Axios를 사용해 React-query로 데이터 불러오는 방식
          </p>
